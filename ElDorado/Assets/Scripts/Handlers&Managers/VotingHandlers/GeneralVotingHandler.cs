...
public class GeneralVotingHandler : MonoBehaviour
{
    ...
    public GameObject noKickVoteSlotHolder;
    public GameObject noMoveVoteSlotHolder;
    ...
    void Awake()
    {
        ...
        stateHandler.kickVoteStateHasStartedEvent += ResetVotingValues;
    }
        ...
        else
        {
            ...
            switch (stateHandler.GetGameState())
            {
                ...
                case StateHandler.GameState.MovementState:
                    ...
                    noActionVoteSlotHolder = noMoveVoteSlotHolder;
                ...
                case StateHandler.GameState.KickVoteState:
                    GameObject parent = noKickVoteSlotHolder.transform.parent.gameObject;
                    VoteCounter voteCounter = parent.GetComponent<VoteCounter>();
                    voteCounter.numberOfVotes = 0;
                    // noActionVoteSlotHolder.GetComponentInParent<VoteCounter>().numberOfVotes = 0;
                    kickPlayerHandler.KickPlayer(winningOption);
                    this.ResetVotingValues();
                    break;
            }
        }
    ...
    public GameObject GetSlotHolder(int optionId)
    {
        ...
        switch (stateHandler.GetGameState())
        {
            ...
            case StateHandler.GameState.KickVoteState:
                ...
                //goes through each option
                foreach (Transform childTransform in kickingPlayerVotingUI.transform)
                {
                    //finds the option that has the option ID we're looking for
                    if (childTransform.gameObject.GetComponent<VoteCounter>().optionId == optionId)
                    {
